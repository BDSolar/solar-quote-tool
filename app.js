    ...
    try {
        ...
        if (phaseCapWarn) {
            ...
            if (isSigen && desired > 96) {
                ...
                phaseCapWarn.textContent = '[!] ' + desired + ' kWh exceeds Sigenergy system max (96 kWh = 2 stacks × 48 kWh)';
...
function buildBOM() {
    ...
    if (isDualBom) {
        // Dual-stack BOM: 2× ECs, 2× battery groups, 2× mounts, mandatory gateway
