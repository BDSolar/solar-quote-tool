...
const DEFAULT_RATE_CARD_ITEMS = [
    ...
    { sort_order: 19, category: 'electrical', label: 'Switchboard Upgrade',                    pricing_type: 'quoted',      input_type: 'addon',    rate: null,   threshold: null, threshold_type: null,    conditions: null,                                                    applies_to: null },
    ...
    { sort_order: 21, category: 'battery',    label: 'Battery install with solar',             pricing_type: 'flat',        input_type: 'auto',     rate: 2000,   threshold: null, threshold_type: null,    conditions: { has_pv: true, has_battery: true },                     applies_to: null },
    { sort_order: 22, category: 'battery',    label: 'Battery install only',                   pricing_type: 'flat',        input_type: 'auto',     rate: 2500,   threshold: null, threshold_type: null,    conditions: { has_pv: false, has_battery: true },                    applies_to: null },
    { sort_order: 23, category: 'battery',    label: 'Battery install with solar (dual stack)', pricing_type: 'flat',       input_type: 'auto',     rate: 2000,   threshold: null, threshold_type: null,    conditions: { has_pv: true, has_battery: true, dual_stack: true },   applies_to: null },
    { sort_order: 24, category: 'battery',    label: 'Battery install only (dual stack)',      pricing_type: 'flat',        input_type: 'auto',     rate: 3000,   threshold: null, threshold_type: null,    conditions: { has_pv: false, has_battery: true, dual_stack: true },  applies_to: null },
    { sort_order: 25, category: 'battery',    label: 'Backup circuits inc RCBO - per circuit', pricing_type: 'per_circuit', input_type: 'auto',     rate: 200,    threshold: null, threshold_type: null,    conditions: { has_backup: true },                                    applies_to: 'backupCircuitCount' },
    { sort_order: 26, category: 'access',     label: 'Site inspection',                        pricing_type: 'flat',        input_type: 'addon',    rate: 250,    threshold: null, threshold_type: null,    conditions: null,                                                    applies_to: null },
    { sort_order: 27, category: 'travel',     label: 'Travel (per km after threshold)',         pricing_type: 'per_km',      input_type: 'addon',    rate: 1.30,   threshold: null, threshold_type: 'after', conditions: null,                                                    applies_to: 'travelKm' },
];
